...
export class MealOrderVerificationService {
  ...
  getMealOrderVerification(id: any): Observable<MealOrderVerification> {
    return this.http.get<MealOrderVerification>(this.baseUrl + 'MealOrderVerification/' + id);
  }
  ...
  getMealOrderVerifications(page?, itemsPerPage?, MealOrderVerificationParams?): Observable<PaginatedResult<MealOrderVerification[]>> {
  ...
  if (MealOrderVerificationParams != null) {
    if (MealOrderVerificationParams.date != null) {
      params = params.append('OrderEntryDate', MealOrderVerificationParams.date);
    }
    if (MealOrderVerificationParams.department != null) {
      params = params.append('DepartmentId', MealOrderVerificationParams.department);
    }
    if (MealOrderVerificationParams.OrderBy != null) {
      params = params.append('OrderBy', MealOrderVerificationParams.OrderBy);
      params = params.append('isDescending', MealOrderVerificationParams.isDesc);
    }
  }
  // console.log(MealOrderVerificationParams.date);

  return this.http.get<MealOrderVerification[]>(this.baseUrl + 'MealOrderVerification/paged', { observe: 'response', params })
    .pipe(
      map(response => {
